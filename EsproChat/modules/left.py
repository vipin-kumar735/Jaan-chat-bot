...
@EsproChat.on_chat_member_updated(filters.group, group=20)
async def member_has_left(client: EsproChat, member: ChatMemberUpdated):
    ...
    if user.photo and user.photo.big_file_id:
        try:
            ...
            photo = await EsproChat.download_media(user.photo.big_file_id)
